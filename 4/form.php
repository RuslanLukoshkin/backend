        ...
        <form method="POST" action="">
            ...
            <div class="block">
                ...
                <select class="form-select form-select-lg mb-2" name="select[]" multiple <?php if ($errors['select']) {
                    ...
                    <option value="brain" <?php $arr = explode(',', $values['select']);
                                            if ($arr != '') {
                                            ...
                                            ?>>Воланд</option>
                    <option value="magic" <?php $arr = explode(',', $values['select']);
                                            if ($arr != '') {
                                                foreach ($arr as $value) {
                                                    if ($value == "magic") {
                                                        print 'selected';
                                            ...
                                            ?>>Фагот</option>
                    <option value="guns" <?php $arr = explode(',', $values['select']);
                                            if ($arr != '') {
                                                foreach ($arr as $value) {
                                                    if ($value == "guns") {
                                                        print 'selected';
                                            ...
                                            ?>>Азазелло</option>
                    <option value="fun" <?php $arr = explode(',', $values['select']);
                                        if ($arr != '') {
                                            foreach ($arr as $value) {
                                                if ($value == "fun") {
                                                    print 'selected';
